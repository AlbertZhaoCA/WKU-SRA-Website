        ...
        <section className="w-full overflow-hidden dark:bg-gray-900">
            <div className="w-full mx-auto">
                ...
                <div
                    ...
                    <h1 className="text-center text-gray-800 dark:text-white text-2xl font-serif">希望从事软件开发相关行业的cs学习者 📚</h1>
                    <p className="max-w-2xl text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center xs:text-justify">
                        对软件工程，计算机充满了好奇，虽然迟钝，学艺不精，但始终愿意尝试新事物，提升自己的技术水平。前端后端都不精通，但是都想写😫。
                    </p>
                    <h1 className="text-center text-gray-800 dark:text-white text-2xl font-serif">自然语言处理类中语音学分析关注者 👀</h1>
                    <p className="max-w-2xl text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center xs:text-justify">
                        对自然语言处理类中的语音学分析感兴趣，持续关注着开源社区里好用的语音学分析模型的分布 (为什么做这个方向开源的人不多啊，孩子只是买不起API啊😭)
                    </p>

                    <h1 className="text-center text-gray-800 dark:text-white text-2xl font-serif">研究方向</h1>
                    <ul>
                        <li className="text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center xs:text-justify">
                            语音学分析
                        </li>
                        <li className="text-gray-700 dark:text-gray-400 text-md text-pretty sm:text-center xs:text-justify">
                            Typo 分析
