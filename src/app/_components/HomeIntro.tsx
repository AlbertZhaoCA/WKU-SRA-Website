  ...
  return (
    <HeroHighlight>
       <motion.h1
        ...
        className=" px-4 mt-16 xxsm:text-2xl xxsm:leading-normal text-xl xsm:text-3xl xsm:leading-snug sm:text-3xl sm:leading-normal md:text-4xl md:leading-snug  lg:text-3xl font-bold text-neutral-200 dark:text-white max-w-4xl leading-relaxed lg:leading-normal text-center mx-auto" >
